...
ata_lba_read:
    ...
    ; Sned the highest 8 bits of the LBA to hard disk controller 
    shr eax, 24
    or eax, 0xE0 ; Select the master device 
    mov dx, 0x1F6
    out dx, al
    ; Finshed Sending the higest 8 bits of the lba
    mov eax,ecx
    mov dx, 0x1F2
    out dx, al
    ...
    ; Finshed sending the upper 16 bits of the LBA
